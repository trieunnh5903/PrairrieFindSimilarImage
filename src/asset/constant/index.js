...
const icons = {
  cam: require('../../asset/cam.webp'),
  cherry: require('../../asset/cherry.webp'),
  dau: require('../../asset/dau.webp'),
  thom: require('../../asset/thom.webp'),
  chuoi: require('../../asset/chuoi.webp'),
  bgHome: require('../../asset/bg_home.png'),
  btn_letgo: require('../../asset/btn_letgo.png'),
};
